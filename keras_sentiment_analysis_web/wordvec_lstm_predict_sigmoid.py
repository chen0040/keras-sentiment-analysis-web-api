...
class WordVecLstmSigmoid(object):
    ...
    def __init__(self):
        json = open('../keras_sentiment_analysis/models/lstm_sigmoid_architecture.json', 'r').read()
        self.model = model_from_json(json)
        self.model.load_weights('../keras_sentiment_analysis/models/lstm_sigmoid_weights.h5')
