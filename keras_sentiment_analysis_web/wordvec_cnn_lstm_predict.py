...
class WordVecCnnLstm(object):
    ...
    def __init__(self):
        json = open('../keras_sentiment_analysis_train/models/wordvec_cnn_lstm_architecture.json', 'r').read()
        self.model = model_from_json(json)
        self.model.load_weights('../keras_sentiment_analysis_train/models/wordvec_cnn_lstm_weights.h5')
