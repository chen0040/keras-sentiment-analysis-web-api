...
model.add(Bidirectional(LSTM(units=64, dropout=0.2, recurrent_dropout=0.2, input_shape=(MAX_LENGTH, EMBED_SIZE))))
...
with open('models/bidirectional_lstm_softmax_architecture.json', 'w') as file:
    file.write(model.to_json())
model.save_weights('models/bidirectional_lstm_softmax_weights.h5')